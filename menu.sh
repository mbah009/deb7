...
echo -e "\033[1;31m15\033[0m) Set limit login SSH                  | \033[1;32mKill multilogin ssh\033[0m"
echo -e "\033[1;31m16\033[0m) Set limit 1 login SSH (Optional)       | \033[1;32mKill multilogin ssh\033[0m"
echo -e "\033[1;31m17\033[0m) Set limit 2 login SSH (Optional)       | \033[1;32mKill multilogin ssh\033[0m"
