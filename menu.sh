...
echo -e "\033[1;31m15\033[0m) Set limit login SSH (Debian)         | \033[1;32mKill multilogin ssh\033[0m"
echo -e "\033[1;31m16\033[0m) Set limit 1 login SSH (Ubuntu)       | \033[1;32mKill multilogin ssh\033[0m"
echo -e "\033[1;31m17\033[0m) Set limit 2 login SSH (Ubuntu)       | \033[1;32mKill multilogin ssh\033[0m"
echo -e "\033[1;31m18\033[0m) Jumlah RAM yang sedang digunakan     | \033[1;32mTotal used RAM\033[0m"
